...
/*   Updated: 2024/02/13 03:30:25 by akambou          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	join_threads(pthread_t *threads, int num_philosophers, t_shared *shared)
{
	int		i;
	void	*ret;
...
int	main(int argc, char **argv)
{
	...
	join_threads(threads, num_philosophers, &shared);
